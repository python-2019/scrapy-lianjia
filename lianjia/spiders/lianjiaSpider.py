...
class lianjiaSpider(scrapy.Spider):
    name = 'lianjia'
    allowed_domains = ['cd.fang.lianjia']
    ...
    def parse(self, response):
        ...
        for div in div_list:
            ...
            item['base_info'] = div.xpath("./div[1]/span").extract()
        ...
        for page in range(self.page_last):
            next_page_url = self.host + self.page_url + str((page + 1))
            print(next_page_url)
